...
--      transaction open.
--   3. Read the NOTICE output in the Messages / Results panel. Every
--      line is prefixed PASS, FAIL or INCONCLUSIVE, and the last line is
--      a tally.
--
...
-- transaction that ends in ROLLBACK. PostgreSQL rolls back DDL, so after
-- this runs the database is byte-identical to before, whether 091 has
-- been applied or not.
--
...
--
-- >>> "Success. No rows returned" IS NOT THE RESULT. <<< That message
-- appears for this file, for a real apply, for a dry run, and for a
-- correct file pasted into the wrong project's tab. THE NOTICE LINES ARE
-- THE RESULT. If you see no NOTICE output at all, the DO block did not
-- run and you have learned nothing.
--
-- =====================================================================
...
-- no test file. The tally at the end asserts 11 assertions ran; a set of
-- six columns should make it 12.
-- =====================================================================
