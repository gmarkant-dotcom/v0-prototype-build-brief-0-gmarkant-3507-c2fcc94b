  ...
  return (
    <TooltipPrimitive.Portal>
      <TooltipPrimitive.Content
        ...
        className={cn(
          // pointer-events-none: tooltip content is informational only, per the app-wide
          // hover-intent rule (popovers never block their trigger) - a zero sideOffset default
          // let a wide nav tooltip render flush against/over its neighbor's clickable area,
          // intercepting clicks meant for the trigger underneath.
