  ...
  return (
    <AgencyLayout>
      <div className="p-8 max-w-6xl space-y-8">
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <div className="text-foreground-muted">$699/month · Renews Apr 1, 2026</div>
              </div>
            </div>
        ...
        <div>
          <h2 className="font-display font-bold text-xl text-foreground mb-4">Available Plans</h2>
